...
import {
  ...
  useId,
  useLayoutEffect2
} from "./chunk-OF6R7MNU.js";
import {
  require_react_dom
} from "./chunk-H52YI2DL.js";
import {
  require_shim
} from "./chunk-OFVNZM6T.js";
import {
  require_jsx_runtime
...
var Form = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    const [validityMap, setValidityMap] = React20.useState({});
    const getFieldValidity = React20.useCallback(
      (fieldName) => validityMap[fieldName],
      [validityMap]
    );
    const handleFieldValidityChange = React20.useCallback(
    ...
    const handleFieldValiditionClear = React20.useCallback((fieldName) => {
      setValidityMap((prevValidityMap) => ({ ...prevValidityMap, [fieldName]: void 0 }));
      setCustomErrorsMap((prevCustomErrorsMap) => ({ ...prevCustomErrorsMap, [fieldName]: {} }));
    }, []);
    const [customMatcherEntriesMap, setCustomMatcherEntriesMap] = React20.useState({});
    const getFieldCustomMatcherEntries = React20.useCallback(
      (fieldName) => customMatcherEntriesMap[fieldName] ?? [],
      [customMatcherEntriesMap]
    );
    const handleFieldCustomMatcherAdd = React20.useCallback((fieldName, matcherEntry) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
        [fieldName]: [...prevCustomMatcherEntriesMap[fieldName] ?? [], matcherEntry]
      }));
    }, []);
    const handleFieldCustomMatcherRemove = React20.useCallback((fieldName, matcherEntryId) => {
      setCustomMatcherEntriesMap((prevCustomMatcherEntriesMap) => ({
        ...prevCustomMatcherEntriesMap,
    ...
    const [customErrorsMap, setCustomErrorsMap] = React20.useState({});
    const getFieldCustomErrors = React20.useCallback(
      (fieldName) => customErrorsMap[fieldName] ?? {},
      [customErrorsMap]
    );
    const handleFieldCustomErrorsChange = React20.useCallback((fieldName, customErrors) => {
      setCustomErrorsMap((prevCustomErrorsMap) => ({
        ...prevCustomErrorsMap,
        [fieldName]: { ...prevCustomErrorsMap[fieldName] ?? {}, ...customErrors }
      }));
    }, []);
    const [messageIdsMap, setMessageIdsMap] = React20.useState({});
    const handleFieldMessageIdAdd = React20.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
        const fieldDescriptionIds = new Set(prevMessageIdsMap[fieldName]).add(id);
        return { ...prevMessageIdsMap, [fieldName]: fieldDescriptionIds };
      });
    }, []);
    const handleFieldMessageIdRemove = React20.useCallback((fieldName, id) => {
      setMessageIdsMap((prevMessageIdsMap) => {
    ...
    const getFieldDescription = React20.useCallback(
...
var FormControl = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    const updateControlValidity = React20.useCallback(
      async (control) => {
    ...
    const resetControlValidity = React20.useCallback(() => {
      const control = ref.current;
      if (control) {
...
var FormMessage = React20.forwardRef(
  (props, forwardedRef) => {
...
var FormBuiltInMessage = React20.forwardRef(
  (props, forwardedRef) => {
...
var FormCustomMessage = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    const _id = useId();
    const id = idProp ?? _id;
    const customMatcherEntry = React20.useMemo(() => ({ id, match }), [id, match]);
...
var FormMessageImpl = React20.forwardRef(
  (props, forwardedRef) => {
...
var FormSubmit = React20.forwardRef(
  (props, forwardedRef) => {
...
var NavigationMenuViewportImpl = React24.forwardRef((props, forwardedRef) => {
  ...
  const [size2, setSize] = React24.useState(null);
...
var ToastImpl = React37.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime35.jsxs)(import_jsx_runtime35.Fragment, { children: [
      ...
      (0, import_jsx_runtime35.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM3.createPortal(
